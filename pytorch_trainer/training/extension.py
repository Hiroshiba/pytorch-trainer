...
class Extension(object):
    ...
    Attributes:
        ...
        ~Extension.name: Name of the extension. It is set to
            ...
            :meth:`pytorch_trainer.training.Trainer.extend` for details.
    ...
    def initialize(self, trainer):
        ...
        that modifies the state of :class:`~pytorch_trainer.training.Trainer` can
        ...
        For example, :class:`~pytorch_trainer.training.extensions.ExponentialShift`
        ...
        The :class:`~pytorch_trainer.training.extensions.ExponentialShift` extension

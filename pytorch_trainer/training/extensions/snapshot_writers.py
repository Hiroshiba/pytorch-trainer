...
class Writer(object):
    ...
    :class:`~pytorch_trainer.training.extensions.Snapshot` invokes ``__call__`` of this
    class every time when taking a snapshot.
    This class determines how the actual saving function will be invoked.

    .. seealso::

        - :meth:`pytorch_trainer.training.extensions.snapshot`
    """
    ...
    def __call__(self, filename, outdir, target):
        ...
        :class:`~pytorch_trainer.training.extensions.Snapshot` object every time it
        takes a snapshot.
        ...
        Args:
            ...
            outdir (str): Output directory. Corresponds to
                :py:attr:`Trainer.out <pytorch_trainer.training.Trainer.out>`.
    ...
    def finalize(self):
        ...
        Like extensions in :class:`~pytorch_trainer.training.Trainer`, this method
